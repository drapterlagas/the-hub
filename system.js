...
const devTylor = "254725474072";
const mainOwner = "254725474072@s.whatsapp.net";
const {
  smsg,
  formatDate,
  getTime,
...
const tylorkid1 = fs.readFileSync("./Media/Images/nector.jpg");
const tylorkid2 = fs.readFileSync("./Media/Images/nector.jpg");
const tylorkid3 = fs.readFileSync("./Media/Images/nector.jpg");
const tylorkid4 = fs.readFileSync("./Media/Images/necror.jpg");
const tylorkid5 = fs.readFileSync("./Media/Images/nector.jpg");
...
module.exports = Cypher = async (_0x1548f3, _0x50668e, _0x8403a4, _0x1f8e8d) => {
  try {
    ...
    try {
      ...
      let _0x2f0bd = "https://files.catbox.moe/ckn89y.jpg";
    }
    let _0x140496 = await getBuffer(_0x2fccde);
    let _0xf87fc5 = await _0x1548f3.profilePictureUrl(_0x50668e.sender, "image").catch(_0x3df84c => "https://files.catbox.moe/ckn89y.jpg");
    try {
...
if (!("antilinkgckick" in _0x4e02f1)) {
    ...
    if (_0x50668e.message) {
      lolcatjs.fromString("┏━━━━━━━━━━━━━『 ░T░H░E░ ░H░U░B░ 』━━━━━━━━━━━━━─");
...
if (_0x1f0527.endsWith("@g.us") && db.data.chats[_0x50668e.chat]?.antiimage) {
  if (_0x50668e.message?.imageMessage && !_0x419a1c && !_0x22e08b && _0x26d2c7) {
    ...
    if (["120363395396503029@g.us", "120363395396503029@g.us"].includes(_0x50668e.chat)) {
      ...
      _0x1548f3.sendMessage(_0x50668e.chat, {
        ...
        contextInfo: {
          ...
          forwardedNewsletterMessageInfo: {
            ...
            serverMessageId: 20,
            newsletterName: "░T░H░E░ ░H░U░B░"
          },
          externalAdReply: {
            title: "░T░H░E░ ░H░U░B░",
            body: "",
            thumbnailUrl: "https://files.catbox.moe/ckn89y.jpg",
            sourceUrl: null,
            mediaType: 1
          }
        }
...
info += _0x1746ba + "\n\n";
        ...
        if (global.db.data.settings.menustyle === "1") {
          _0x1548f3.sendMessage(_0x50668e.chat, {
            document: {
              url: "https://files.catbox.moe/ckn89y.jpg"
            },
            caption: _0x52aa90,
